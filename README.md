...
We have used sts spring tool platform ,Java,spring ,spring boot framework , annotations model,service,service implementation,controller,data access layer ,mysql, for building this Project. We also used tools like GitHub for collaboration of our project, Slack & Zoom as means of a communication channel.
