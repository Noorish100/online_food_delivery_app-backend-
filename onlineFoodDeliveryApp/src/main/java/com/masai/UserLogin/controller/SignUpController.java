...
public class SignUpController {
	...
	public SignUp updateSignUpDetailsHandler(@RequestBody SignUp signUp, @RequestParam(required=false) String key)
	{
		return signUpService.updateSignUpDetails(signUp,key);
	}
